            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="text-center">
                        <img src="<?= BASE_URL . $thongTin['anh_dai_dien']; ?>" class="avatar img-circle" style="width:100px;" alt="avatar" onerror="this.onerror = null; this.src='https://static.vecteezy.com/system/resources/previews/016/774/583/original/3d-user-icon-on-transparent-background-free-png.png'">
