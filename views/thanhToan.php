                ...
                <div class="checkout-billing-details-wrap">
                    ...
                    <div class="billing-form-wrap">
                            ...
                            <div class="single-input-item">
                                ...
                                <input type="text" id="sdt_nguoi_nhan" name="sdt_nguoi_nhan" value="<?= $user['so_dien_thoai'] ?>" placeholder="Vui lòng nhập số điện thoại" required />
                            </div>
                            <div class="single-input-item">
                                <label for="dia_chi_nguoi_nhan" class="required">Địa chỉ người nhận</label>
                                <input type="text" id="dia_chi_nguoi_nhan" name="dia_chi_nguoi_nhan" value="<?= $user['dia_chi'] ?>" placeholder="Vui lòng nhập địa chỉ" required />
                            </div>
