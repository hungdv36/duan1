                ...
                <div class="col-lg-3 order-2 order-lg-1">
                    <aside class="sidebar-wrapper">
                        ...
                        <div class="sidebar-single">
                            ...
                            <div class="sidebar-body p-3 bg-light rounded">
                                <form action="<?= BASE_URL . '?act=shop' ?>" method="post">
                                    <div class="mb-3">
                                        <label for="gia_min" class="form-label">Từ:</label>
                                        <input type="number" name="gia_min" id="gia_min" class="form-control"
                                            value="<?= isset($_POST['gia_min']) ? $_POST['gia_min'] : '' ?>"
                                            placeholder="0" min="0">
                                    </div>
                                    <div class="mb-3">
                                        <label for="gia_max" class="form-label">Đến:</label>
                                        <input type="number" name="gia_max" id="gia_max" class="form-control"
                                            value="<?= isset($_POST['gia_max']) ? $_POST['gia_max'] : '' ?>"
                                            placeholder="10000000" min="0">
                                    </div>
                                    <button type="submit" class="btn btn-sqr w-100">Lọc</button>
                                </form>
                            </div>
