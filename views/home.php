                    ...
                    <div class="product-container">
                        ...
                        <div class="product-tab-menu">
                            <ul class="nav justify-content-center">
                                ...
                                <li><a href="#tab<?=$danhMuc['id']?>" data-bs-toggle="tab"><?=$danhMuc['ten_danh_muc']?></a></li>
                                <?php }?>
                            </ul>
                        </div>
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="product-details.html">
                                                    <img class="pri-img" src="<?=!empty($sanPham['hinh_anh']) ? $sanPham['hinh_anh'] : 'views/assets/img/product/product-1.jpg'?>" alt="product">
                                                    <img class="sec-img" src="<?=!empty($sanPham['hinh_anh']) ? $sanPham['hinh_anh'] : 'views/assets/img/product/product-18.jpg'?>" alt="product">
                                                </a>
                                                <div class="product-badge">
                                                    ...
                                                    <?php
                                                    $giaGoc = (float) $sanPham['gia_san_pham'];
                                                    $giaKhuyenMai = (float) $sanPham['gia_khuyen_mai'];
                                                ...
                                                <div class="button-group">
                                                    ...
                                                    <a href="#" data-bs-toggle="modal" data-bs-target="#quick_view<?=$sanPham['id']?>"><span data-bs-toggle="tooltip" data-bs-placement="left" title="Quick View"><i class="pe-7s-search"></i></span></a>
                                                </div>
                                            ...
                                            <div class="product-caption text-center">
                                                ...
                                                <h6 class="product-name">
                                                    <a href="?act=chi-tiet-san-pham&id=<?=$sanPham['id']?>&id_danhmuc=<?=$sanPham['danh_muc_id']?>"><?=$sanPham['ten_san_pham'] ?? ""?></a>
                                                </h6>
                                                <div class="price-box">
                    ...
                    <div class="product-banner-carousel slick-row-10">
                        ...
                        <div class="banner-slide-item">
                            <figure class="banner-statistics">
                                <a href="#">
                                    <img src="views/assets/img/banner/img1-middle.jpg" alt="<?=$danhMuc['ten_danh_muc']?>">
                                </a>
                            ...
                            <div class="product-item">
                                <figure class="product-thumb">
                                    ...
                                    <div class="product-badge">
                                        ...
                                        <?php
                                        $giaGoc = (float) $spNoiBat['gia_san_pham'];
                                        $giaKhuyenMai = (float) $spNoiBat['gia_khuyen_mai'];
                                        $phanTramGiam = ($giaGoc > 0) ? round((($giaGoc - $giaKhuyenMai) / $giaGoc) * 100) : 0;
                                        ?>
                                    ...
                                    <div class="button-group">
                                        <a href="wishlist.html" data-bs-toggle="tooltip" data-bs-placement="left" title="Add to wishlist"><i class="pe-7s-like"></i></a>
                                        <a href="compare.html" data-bs-toggle="tooltip" data-bs-placement="left" title="Add to Compare"><i class="pe-7s-refresh-2"></i></a>
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#quick_view<?=$spNoiBat['id']?>"><span data-bs-toggle="tooltip" data-bs-placement="left" title="Quick View"><i class="pe-7s-search"></i></span></a>
                                    </div>
                                    <div class="cart-hover">
                                        <input type="hidden" name="san_pham_id" value="<?=$spNoiBat['id']?>">
                                        <input type="hidden" name="so_luong" value="1">
                                        <button type="submit" class="btn btn-cart">add to cart</button>
                                    </div>
                                </figure>
                                <div class="product-caption text-center">
                                    <div class="product-identity">
                                        <p class="manufacturer-name"><a href="product-details.html"><?=$spNoiBat['ten_danh_muc']?></a></p>
                                    </div>
                                    <h6 class="product-name">
                                        <a href="?act=chi-tiet-san-pham&id=<?=$spNoiBat['id']?>&id_danhmuc=<?=$spNoiBat['danh_muc_id']?>"><?=$spNoiBat['ten_san_pham']?></a>
                                    </h6>
                                    <div class="price-box">
                                        <span class="price-regular"><?=$spNoiBat['gia_khuyen_mai']?></span>
                                        <span class="price-old"><del><?=$spNoiBat['gia_san_pham']?></del></span>
                                    </div>
                                </div>
                            </div>
                        </form>
...
<?php foreach ($danhSachSanPhamNoiBat as $spNoiBat){?>
<div class="modal" id="quick_view<?=$spNoiBat['id']?>">
                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="product-large-slider">
                                <?php
                                $hinhAnhSanPham = explode(',', $sanPham['hinh_anh_san_pham']);
                                ?>
                                <?php foreach ($hinhAnhSanPham as $hinhAnh){?>
                                    <div class="pro-large-img img-zoom">
                                        <img src="<?=!empty($hinhAnh) ? $hinhAnh : 'views/assets/img/product/product-details-img1.jpg'?>" alt="product-details" />
                                    </div>
                                <?php }?>
                            </div>
                        ...
                        <div class="col-lg-7">
                            <div class="product-details-des">
                                <div class="manufacturer-name">
                                    <a href="product-details.html"><?=$spNoiBat['ten_danh_muc']?></a>
                                </div>
                                <h3 class="product-name"><?=$spNoiBat['ten_san_pham']?></h3>
                                ...
                                <div class="availability">
                                    ...
                                    <span><?=$spNoiBat['so_luong']?> in stock</span>
                                </div>
                                <p class="pro-desc"><?=$spNoiBat['mo_ta']?></p>
