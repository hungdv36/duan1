                        ...
                        <div class="main-menu-area">
                            <div class="main-menu">
                                ...
                                <nav class="desktop-menu">
                                    <ul>
                                        <li class="active"><a href="?act=trang-chu">Home <i class="fa fa-angle-down"></i></a>
                                            <ul class="dropdown">
                                            ...
                                            <ul class="megamenu dropdown">
                                                ...
                                                <li class="megamenu-banners d-none d-lg-block">
                                                    <a href="product-details.html">
                                                        <img src="views/assets/img/banner/img1-static-menu.jpg" alt="">
                                                    </a>
                                                </li>
                                                <li class="megamenu-banners d-none d-lg-block">
                                                    <a href="product-details.html">
                                                        <img src="views/assets/img/banner/img2-static-menu.jpg" alt="">
                                                    </a>
                                                </li>
                                            </ul>
                                        </li>
                                ...
                                <ul class="nav justify-content-end">
                                    <li class="user-hover">
                                        ...
                                        <ul class="dropdown-list">
                                            ...
                                            if(isset($_SESSION['user'])){
                                                echo '<li><a href="?act=dang-xuat">Đăng xuất</a></li>';
                                            } else {
                                                echo '<li><a href="?act=dang-nhap">Đăng nhập</a></li>';
                                            }
                                            ?>
                                    ...
                                    <li>
                                        <a href="#" class="minicart-btn">
                                            ...
                                            <div class="notification"><?= isset($chiTietGioHang) && is_array($chiTietGioHang) ? count($chiTietGioHang) : 0 ?></div>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li>
                            <div class="dropdown mobile-top-dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="myaccount">
                                    ...
                                    <a class="dropdown-item" href="?act=dang-nhap">Đăng nhập</a>
